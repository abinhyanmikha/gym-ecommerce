  ...
  if (cart.length === 0) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="text-gray-600 mb-8">Looks like you haven't added any gym equipment yet.</p>
          ...
          {cart.map(item => (
            <div key={item._id} className="bg-white p-4 rounded-lg shadow flex items-center gap-4">
              ...
              <div className="flex-grow">
                <Link href={`/product/${item._id}`} className="font-semibold text-lg hover:text-blue-600">
                  {item.name}
                </Link>
